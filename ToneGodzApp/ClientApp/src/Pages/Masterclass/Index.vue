...
<template>
  <!-- Video library -->
  <p class="w-[90%] mx-auto text-2xl lg:px-12 my-8">Masterclass</p>
  <div
  ...
  >
    <!-- video card item -->
    <a
      v-for="folder in reversedItems"
      class="flex flex-col w-fit bg-[rgb(82_81_81/50%)] p-2 rounded-lg shadow"
      :href="`/masterclass/subfolders/${folder.id}`"
    >
      <div class="relative">
        <img
          :src="'/thumbnail.png'"
