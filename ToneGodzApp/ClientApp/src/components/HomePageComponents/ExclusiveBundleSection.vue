<template>
  <div id="exclusiveBundle" class="w-full mt-20">
    <div class="text-container p-8 mx-28 text-center border-b-4">
      <p
        class="title text-left text-5xl text-primary font-extrabold my-10 m-auto"
      >
        EXCLUSIVE BUNDLE
      </p>
